...
ActiveRecord::Schema[7.1].define(version: 20_240_407_090_711) do
  ...
  create_table 'groups_students', id: false, force: :cascade do |t|
    ...
    t.boolean 'captain'
    t.index %w[group_id student_id], name: 'index_groups_students_on_group_id_and_student_id'
  ...
  create_table 'groups_subjects', id: false, force: :cascade do |t|
    ...
    t.index %w[group_id subject_id], name: 'index_groups_subjects_on_group_id_and_subject_id'
    t.index %w[subject_id group_id], name: 'index_groups_subjects_on_subject_id_and_group_id'
  end
